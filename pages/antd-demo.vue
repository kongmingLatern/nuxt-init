<template>
  <div class="container mx-auto py-10 px-4">
    <h1 class="text-3xl font-bold mb-8">Ant Design Vue 组件示例</h1>
    
    <!-- 按钮示例 -->
    <section class="mb-10">
      <h2 class="text-xl font-semibold mb-4">按钮类型</h2>
    ...
    <!-- 按钮危险类型 -->
    <section class="mb-10">
      <h2 class="text-xl font-semibold mb-4">危险按钮</h2>
      <div class="flex flex-wrap gap-4">
    ...
    <section class="mb-10">
      ...
      <div class="flex flex-col gap-4">
        <div class="flex items-center gap-2 mb-2">
          <span class="text-sm text-gray-500 w-20">Size:</span>
    ...
    <section class="mb-10">
      ...
      <div class="flex flex-wrap gap-4">
        ...
        <a-button type="primary" loading :loading-icon="loadingIcon">
          Custom Loading Icon
        </a-button>
        <a-button :loading="loading" @click="toggleLoading">
          {{ loading ? 'Click to stop loading' : 'Click to load' }}
        </a-button>
      </div>
    </section>
    ...
    <!-- 图标按钮 -->
    <section class="mb-10">
      <h2 class="text-xl font-semibold mb-4">图标按钮</h2>
      <div class="flex flex-wrap gap-4">
...
import { ref } from 'vue'
import { LoadingOutlined, SearchOutlined, DownloadOutlined } from '@ant-design/icons-vue'
...
const loadingIcon = ref<any>(LoadingOutlined)
